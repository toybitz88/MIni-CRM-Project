...
<html lang="en">
    <head>
        ...
        <!-- <link href="../css_bootstrap/styles.css" rel="stylesheet" /> -->
    ...
    <body class="sb-nav-fixed">
        ...
        <script src="{{ asset('js_bootstrap/scripts.js') }}" ></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
        <script src="{{ asset('assets_bootstrap/demo/chart-area-demo.js') }}"></script>
        <script src="{{ asset('assets_bootstrap/demo/chart-bar-demo.js') }}"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
        <script src="{{ asset('js_bootstrap/datatables-simple-demo.js') }}"></script>
        <script>
